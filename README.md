...
# Terraform + AWS + Docker Swarm setup for Amazon Linux 2 AMI 2.0.20181008 x86_64 HVM gp2 
...
- make it compatable with AWS new Linux system with yum command 
- adding more files to make it clear for the user 
